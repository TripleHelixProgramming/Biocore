...
public class R_DriveOutAuto extends AutoMode {
  private final AutoTrajectory driveOut;
  private final AutoTrajectory strafe;

  public R_DriveOutAuto(Drive drivetrain) {
    super(drivetrain);
    driveOut = trajectory(ChoreoTraj.RedDriveOut$0);
    strafe = trajectory(ChoreoTraj.RedDriveOut$1);
