...
public class R_BranchExampleAuto extends AutoMode {
   ...
   */
  public R_BranchExampleAuto(Drive drivetrain, BooleanSupplier takeBranchA) {
    super(drivetrain);
    trunk = trajectory(ChoreoTraj.RedBranchTrunk);
    AutoTrajectory branchA = trajectory(ChoreoTraj.RedBranchA);
    AutoTrajectory branchB = trajectory(ChoreoTraj.RedBranchB);
